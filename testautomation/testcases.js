...
describe('User Profiling Test Cases', function() {
  it('Sign Up Page Redirection', function() {
    ...
    var signupButton = driver.findElement(By.xpath('//*[@id="root"]/section/div/div/div/a[1]'));
    signupButton.click();
  ...
  it('Sign In Page Redirection', function() {
    ...
    .build();
    driver.get('http://localhost:3000/');
    var loginButton = driver.findElement(By.xpath('//*[@id="root"]/section/div/div/div/a[2]'));
    loginButton.click();
    driver.getCurrentUrl().then((value)=>{
  ...
  describe("Testing with Random Email " + randomEmail, ()=>{
    ...
    .setFirefoxOptions(new firefox.Options().headless().windowSize(screen))
    .build();
    it(`Resgistering with Random email, ${randomEmail}`, ()=>{
      ...
      var registerButton = driver.findElement(By.xpath('//*[@id="root"]/section/form/input'));
    ...
    it(`Logging out`, ()=>{
      ...
      var logoutButton = driver.findElement(By.xpath('/html/body/div[1]/nav/ul/li[3]/a'));
      logoutButton.click();
      driver.getCurrentUrl().then((value)=>{
        assert.equal(value, "http://localhost:3000/login");
      })
    ...
    it(`Logging In`, ()=>{
      ...
      var passwordInput = driver.findElement(By.name('password'));
      passwordInput.sendKeys("password")
      var loginButton = driver.findElement(By.xpath('//*[@id="root"]/section/form/input'));
      loginButton.click()
      driver.getCurrentUrl().then((value)=>{
        assert.equal(value, "http://localhost:3000/dashboard");
      })
    ...
    it('Redirecting to Profile', ()=>{
      driver.get('http://localhost:3000/login');
      var profileRedirect = driver.findElement(By.xpath('//*[@id="root"]/section/a'));
    ...
    it('Creating Profile', ()=>{
      ...
      var createProfile = driver.findElement(By.xpath('//*[@id="root"]/section/form/input'));
      createProfile.click()
    ...
    it('Delete Profile', ()=>{
      driver.get('http://localhost:3000/dashboard');
      var deleteButton = driver.findElement(By.xpath('//*[@id="root"]/section/div[2]/button'));
      deleteButton.click();
